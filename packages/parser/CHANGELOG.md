...
- size内の入れ子spanと装飾記号を解析できるように修正 ([#76](https://github.com/r74tech/wdpr/pull/76))
...
- **parser:** blockquote内でブロック構文をパースする ([#72](https://github.com/r74tech/wdpr/pull/72))
...
This was a version bump only for @wdprlib/parser to align it with other projects, there were no code changes.
